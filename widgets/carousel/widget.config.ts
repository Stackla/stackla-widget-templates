...
export function getConfig(widgetContainer: WidgetContainer): IWidgetSettings {
  ...
  return {
    ...
    text_tile_user_name_font_size:
      widgetStyle?.text_tile_user_name_font_size ?? 12,
    text_tile_user_name_font_color:
      widgetStyle?.text_tile_user_name_font_color ?? "000000",
    text_tile_user_handle_font_size:
      widgetStyle?.text_tile_user_handle_font_size ?? 12,
    text_tile_user_handle_font_color:
      widgetStyle?.text_tile_user_handle_font_color ?? "000000",
